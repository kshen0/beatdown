...
(function($, undefined) {
	...
	me.TMXOrthogonalRenderer = Object.extend({
		...
		drawTileLayer : function(context, layer, viewport, rect) {
			...
			//fuuuck
			//sound sensitive effects
			//var highval = $('div.high').text();
			var highval = document.getElementById("highval").innerHTML;
			var midval = document.getElementById("midval").innerHTML;
			var lowval = document.getElementById("lowval").innerHTML;
			//top left is (65, 65), bottom right is (767, 479)?
			var width = 702;
			var height = 414;
			...
			//imageObj.onload = function() {
				context.drawImage(imageObj, -9, 0);
			//}
			
			context.fillStyle = "rgba(245, 91, 98, " + (highval*0.7)/100 + ")";
			context.fillRect(25, 25, 295, 40);
			context.fillRect(25, 65, 40, 127);
			context.fillRect(25, 350, 40, 130);
			context.fillRect(25, 480, 295, 40);

			context.fillRect(545, 25, 260, 40);
			context.fillRect(765, 65, 40, 127);
			context.fillRect(765, 352, 40, 128);
			context.fillRect(545, 480, 260, 40);

			context.fillStyle = "rgba(210, 140, 230, " + 0.3 + ")";
			context.fillRect(444, 435, 200, 40);
			context.fillRect(240, 435, 70, 40);

			/*
			context.fillStyle = "rgba(27, 188, 224, " + lowval/100 + ")";
			context.fillRect(65, 65, width/3, height);

			context.fillStyle = "rgba(224, 198, 27, " + midval/100 + ")";
			context.fillRect(65 + (width/3), 65, width/3, height);

			context.fillStyle = "rgba(181, 27, 224, " + highval/100 + ")";
			context.fillRect(65+(2*width/3), 65, width/3, height);
			*/

			//context.fillStyle = "rgba(140, 140, 140, 0.4)";
			//context.fillRect(100, 100, 617, 329);
			//$jQuery();
		}
